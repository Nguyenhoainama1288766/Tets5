...
loadingCompleteText.Text = "Join Nhóm Zalo in information"
...
game.StarterGui:SetCore("SendNotification", {
      Icon = "rbxassetid://16771492968";
      Title = "DUY MOD GAME", 
      Text = "Join For Zalo In Information";
})
local Notif = {}
...
function Notif.New(text, timee)
    ...
    image_button.Image = "rbxassetid://16771492968"
...
ImageButton1.Image = "rbxassetid://16771492968" -- ảnh button ở ngoài --
...
-- để hình to to trước ui
    ...
    function main:AddToggle(TogInfo ,default, callback)
        ...
        ImageLabel.Image = "rbxassetid://16771492968"
...
---------------------------------- Các Tab
local Library = Update:Window("DUY MOD GAME","",Enum.KeyCode.RightControl);
...
Dis:AddSeperator("Discord")
   ...
   Dis:AddLabel("Zalo Chat Duy mod gmame")

Dis:AddButton("Copy Link", function()
setclipboard("https://zalo.me/g/hudugs462") 
end)

Dis:AddLabel("Zalo Buy Source")
Dis:AddButton("Copy Link ", function()
setclipboard("https://zalo.me/g/foqpqm592") 
end)

Dis:AddButton("Copy Link Zalo Buy Source ", function()
setclipboard("https://zalo.me/g/foqpqm592") 
end)
...
Dis:AddLabel("SCRIPT DUY MOD GAME V2 UPDATE")
...
local NotiFrame = Instance.new("Frame")
	...
	function DiscordLib:Notification(text,text2,delays,logo)
		...
		imagenoti.Image = "rbxassetid://16771492968"..tostring(logo)
...
Troll:AddButton("Effect DUY MOD GAME",function()
...
Troll:AddButton("DUY MOD GAME! NỖI TRẬN MỌI NƠI",function()
...
wait(1)
local ID =16771492968 --Này Là Id Ảnh Nha Ní :>>>
